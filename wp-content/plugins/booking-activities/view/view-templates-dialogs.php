...
<div id='bookacti-event-data-dialog' class='bookacti-backend-dialog bookacti-template-dialogs' data-event-id='0' style='display:none;' >
	<form id='bookacti-event-data-form' >
		...
		$event_tabs = apply_filters( 'bookacti_event_dialog_tabs', array (
			array(	'label'			=> __( 'General', 'booking-activities' ),
					'id'			=> 'general',
					'callback'		=> 'bookacti_fill_event_tab_general',
					'parameters'	=> array(),
					'order'			=> 10 ),
			array(	'label'			=> __( 'Repetition', 'booking-activities' ),
					'id'			=> 'repetition',
		...
		?>
			...
			<div>
				...
				<?php
					$tip = __( 'Set the amount of bookings that can be made on this event.', 'booking-activities' );
					$tip .= ' ' . __( 'It will override the activity setting on this event only.', 'booking-activities' );
					bookacti_help_tip( $tip );
				?>
			</div>
		<?php
		...
		?>
			<div id='bookacti-event-repeat-freq-container'>
				...
				<select name='event-repeat-freq' id='bookacti-event-repeat-freq' data-initial-freq='none' >
					<option value='none' selected='selected'>   <?php esc_html_e( 'Do not repeat', 'booking-activities' ); ?>  </option>
					<option value='daily'>                      <?php esc_html_e( 'Daily', 'booking-activities' ); ?>          </option>
					<option value='weekly'>                     <?php esc_html_e( 'Weekly', 'booking-activities' ); ?>         </option>
					<option value='monthly'>                    <?php esc_html_e( 'Monthly', 'booking-activities' ); ?>        </option>
				</select>
				<?php
					$tip = __( 'Set the repetition frequency. This will create an occurence of the event every day, week or month.', 'booking-activities' );
					bookacti_help_tip( $tip );
				?>
			</div>
			<div id='bookacti-event-repeat-period-container'>
				<div>
					...
					<?php
						$tip = __( 'Set the starting date of the repetition. The occurences of the event will be added from this date.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( 'Set the ending date of the repetition. The occurences of the event will be added until this date.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			</div>
			<div id='bookacti-event-exceptions-container'>
				...
				<?php 
					...
					$tip = __( 'You can add exception dates to the repetition. No event occurences will be displayed on the exception dates.', 'booking-activities' );
					bookacti_help_tip( $tip );
				?>
				</label>
		...
		<?php 
			...
			$template_tabs = apply_filters( 'bookacti_template_dialog_tabs', array (
				array(	'label'			=> __( 'General', 'booking-activities' ),
						...
						'order'			=> 10 ),
				array(	'label'			=> __( 'Agenda', 'booking-activities' ),
						'callback'		=> 'bookacti_fill_template_tab_agenda',
						'parameters'	=> array(),
						'order'			=> 40 ),
				array(	'label'			=> __( 'Events', 'booking-activities' ),
						'callback'		=> 'bookacti_fill_template_tab_events',
						'parameters'	=> array(),
						'order'			=> 50 ),
				array(	'label'			=> __( 'Permissions', 'booking-activities' ),
			...
			?>
				<div>
					...
					<?php
						$tip = __( 'Give your calendar a title to easily recognize it in a list.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div id='bookacti-duplicate-template-fields'>
					...
					<?php
						$tip = __( 'If you want to duplicate a calendar, select it in the list. It will copy its events, activities list, and its settings but not the bookings made on it.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( 'The starting date of your calendar. Basically it should be the date of your first event.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( 'The ending date of your calendar. Basically it should be the date of your last event.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			<?php 
			...
			?>
				<div>
					<label for='bookacti-template-data-minTime' >
						<?php 
						_e( 'Day begin', 'booking-activities' );
						?>
					</label>
					<input type='time' name='templateOptions[minTime]' id='bookacti-template-data-minTime' value='00:00'>
					<?php
					$tip = __( "Set when you want the days to begin on the calendar. Ex: '06:00' Days will begin at 06:00am.", 'booking-activities' );
					bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					<label for='bookacti-template-data-maxTime' >
						<?php 
						_e( 'Day end', 'booking-activities' );  
						?>
					</label>
					<input type='time' name='templateOptions[maxTime]' id='bookacti-template-data-maxTime' value='00:00' >
					<?php
					$tip = __( "Set when you want the days to end on the calendar. Ex: '18:00' Days will end at 06:00pm.", 'booking-activities' );
					bookacti_help_tip( $tip );
					?>
				</div>
				<div>
			...
			?>
				<div>
					<label for='bookacti-template-availability-period-start' ><?php /* translators: Followed by a field indicating a number of days before the event. E.g.: "Events will be bookable in 2 days from today". */ esc_html_e( 'Events will be bookable in', 'booking-activities' ); ?></label>
					<input	type='number' 
				...
				<div>
					<label for='bookacti-template-availability-period-end' ><?php /* translators: Followed by a field indicating a number of days before the event. E.g.: "Events are bookable for up to 30 days from today". */ esc_html_e( 'Events are bookable for up to', 'booking-activities' ); ?></label>
					<input	type='number' 
			...
			?>	
				<div id='bookacti-template-managers-container' class='bookacti-items-container' data-type='users' >
					...
					<?php 
						...
						$tip  = __( 'Choose who is allowed to access this calendar.', 'booking-activities' );
						/* translators: %s = capabilities name */
						$tip .= ' ' . sprintf( __( 'All administrators already have this privilege. If the selectbox is empty, it means that no users have capabilities such as %s.', 'booking-activities' ), '"bookacti_edit_templates" / "bookacti_read_templates"' );
						/* translators: %1$s = Order for Customers add-on link. %2$s = Points of sale add-on link. %3$s = User role editor plugin name. */
						$tip .= '<br/>' . sprintf( __( 'Operators from %1$s add-on and Point of sale managers from %2$s add-on have these capabilities. If you want to grant a user these capabilities, use a plugin such as %3$s.', 'booking-activities' ), 
		...
		<div id='bookacti-activity-dialog-lang-switcher' class='bookacti-lang-switcher' ></div>
			...
			<?php
				...
				$activity_tabs = apply_filters( 'bookacti_activity_dialog_tabs', array (
					array(	'label'			=> __( 'General', 'booking-activities' ),
							...
							'parameters'	=> array(),
							'order'			=> 10 ),
					array(	'label'			=> __( 'Availability', 'booking-activities' ),
							'callback'		=> 'bookacti_fill_activity_tab_availability',
							'parameters'	=> array(),
							'order'			=> 20 ),
					array(	'label'			=> __( 'Text', 'booking-activities' ),
			...
			?>
				<div>
					...
					<?php
						$tip = __( 'Choose a short and relevant title for your activity. It will be shown on each events.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
				...
				<div>
					...
					<div class='bookacti-display-inline-block' >
						...
						echo esc_html( _x( 'd', 'd for days', 'booking-activities' ) ); ?>
						<input type='number' 
						...
						echo esc_html( _x( 'h', 'h for hours', 'booking-activities' ) ); ?>
						<input type='number' 
						...
						echo esc_html( _x( 'm', 'm for minutes', 'booking-activities' ) );
				...
				<div>
					...
					<?php
						...
						$tip = __( "Allow to resize an event directly on calendar.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( 'Choose a color for the events of this activity.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			<?php
			...
			?>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'The minimum booking quantity a user has to make on an event of this activity. E.g.: "3", the customer must book at least 3 places of the desired event.', 'booking-activities' );
				...
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'The maximum booking quantity a user can make on an event of this activity. E.g.: "1", the customer can only book one place of the desired event, and he won\'t be allowed to book it twice.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "0" to ignore this parameter.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'Set how many different users can book the same event. E.g.: "1", only one user can book a specific event; once he has booked it, the event won\'t be available for anyone else anymore, even if it isn\'t full. Usefull for private events.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "0" to ignore this parameter.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						_e( 'days before the event', 'booking-activities' );
						$tip = __( 'Set the end of the period during which reservation changes are allowed (cancellation, rescheduling). E.g.: "7", your customers may change their reservations at least 7 days before the start of the event. After that, they won\'t be allowed to change them anymore.', 'booking-activities' );
						$tip .= '<br/>' . __( 'This parameter applies to the events of this activity only. A global parameter is available in global settings.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "-1" to use the global value.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			...
			?>
				<div>
					...
					<?php
						$tip = __( "Name of the unit the customers will actually book for this activity. Set the singular here. Leave blank to hide this piece of information. Ex: 'You have booked 1 <strong><em>unit</em></strong>'.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( "Name of the unit the customers will actually book for this activity. Set the plural here. Leave blank to hide this piece of information. Ex: 'You have booked 2 <strong><em>units</em></strong>'.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						...
						$tip = __( "Show the unit in the availability boxes. Ex: '2 <strong><em>units</em></strong> available' instead of '2'.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						$tip = __( "The number of persons who can do the activity with 1 booking. Set 0 to hide this piece of information. Ex: 'You have booked 1 unit for <em>2</em> persons'.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			<?php
			...
			?>
				<div>
					<label for='bookacti-activity-roles' class='bookacti-fullwidth-label' >
						...
						$tip  = __( 'Choose who is allowed to book the events of this activity.', 'booking-activities' );
						$tip  .= '<br/>' . __( 'Use CTRL+Click to pick or unpick a role. Don\'t pick any role to allow everybody.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
					</label>
					<div>
				...
				<div id='bookacti-activity-managers-container' class='bookacti-items-container' data-type='users' >
					<label id='bookacti-activity-managers-title' class='bookacti-fullwidth-label' >
						...
						$tip  = __( 'Choose who is allowed to change this activity parameters.', 'booking-activities' );
						/* translators: %s = capabilities name */
						$tip .= ' ' . sprintf( __( 'All administrators already have this privilege. If the selectbox is empty, it means that no users have capabilities such as %s.', 'booking-activities' ), '"bookacti_edit_activities"' );
						$tip .= '<br/>' . sprintf( __( 'Operators from %1$s add-on and Point of sale managers from %2$s add-on have these capabilities. If you want to grant a user these capabilities, use a plugin such as %3$s.', 'booking-activities' ), 
									'<a href="https://booking-activities.fr/en/downloads/order-for-customers/?utm_source=plugin&utm_medium=plugin&utm_campaign=order-for-customers&utm_content=infobulle-permission" target="_blank" >Order for Customers</a>',
									'<a href="https://booking-activities.fr/en/downloads/points-of-sale/?utm_source=plugin&utm_medium=plugin&utm_campaign=points-of-sale&utm_content=infobulle-permission" target="_blank" >Points of Sale</a>',
									'<a href="https://wordpress.org/plugins/user-role-editor/" target="_blank" >User Role Editor</a>'
...
//						/* translators: This is one of the capabilities following the text 'There are bookings on at least one of the occurence of this event. You can:'. */
//				echo  '<li>' . __( 'Unbind all occurences.', 'booking-activities' ) . '</li>';
			?>
        </ul>
...
<div id='bookacti-group-of-events-dialog' class='bookacti-backend-dialog bookacti-template-dialogs' style='display:none;' >
	<form id='bookacti-group-of-events-form' >
		...
		?>
				<div>
					<?php
						$tip = __( "Name this group of events. Your cutomers may see this name if they have several booking choices (if the event is in two groups, or if you also allow to book the event alone). Choose a short and relevant name.", 'booking-activities' );
						$args = array(
							'type'			=> 'textarea',
				...
				<div>
					...
					<select name='group-of-events-category' id='bookacti-group-of-events-category-selectbox' >
						<option value='new' ><?php _e( 'New category', 'booking-activities' ); ?></option>
						<?php
					...
					<?php
						$tip = __( "Pick a category for your group of events.", 'booking-activities' );
						$tip .= __( "Thanks to categories, you will be able to choose what groups of events are available on what booking forms.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div id='bookacti-group-of-events-new-category-title' >
					...
					<?php
						$tip = __( "Name the group of events category.", 'booking-activities' );
						$tip .= __( "Thanks to categories, you will be able to choose what groups of events are available on what booking forms.", 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
			...
			?>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'The minimum booking quantity a user has to make on a group of events of this category. E.g.: "3", the customer must book at least 3 places of the desired group of events.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "0" to ignore this parameter.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'The maximum booking quantity a user can make on a group of events of this category. E.g.: "1", the customer can only book one place of the desired group of events, and he won\'t be allowed to book it twice.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "0" to ignore this parameter.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						$tip = __( 'Set how many different users can book the same group of events. E.g.: "1", only one user can book a specific group of events; once he has booked it, the group of events won\'t be available for anyone else anymore, even if it isn\'t full. Usefull for private events.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "0" to ignore this parameter.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<input	type='number' 
							...
							onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
					<?php
						_e( 'days before the first event', 'booking-activities' );
						$tip = __( 'Set the end of the period during which reservation changes are allowed (cancellation). E.g.: "7", your customers may change their reservations at least 7 days before the start of the first event of the group. After that, they won\'t be allowed to change them anymore.', 'booking-activities' );
						$tip .= '<br/>' . __( 'This parameter applies to the groups of events of this category only. A global parameter is available in global settings.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "-1" to use the global value.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
				</div>
				<div>
					...
					<?php
						...
						$tip .= '<br/>' . __( 'This parameter applies to the groups of events of this category only. A global parameter is available in global settings.', 'booking-activities' );
						$tip .= '<br/>' . __( 'Set it to "Site setting" to use the global value.', 'booking-activities' );
						...
						$args = array(
							...
							'options'	=> array( 
								...
								'0' => __( 'No', 'booking-activities' ),
								'1' => __( 'Yes', 'booking-activities' )
							),
							'value'	=> -1,
							'tip'	=> $tip
						);
			...
			?>
				<div>
					<label for='bookacti-group-category-roles' class='bookacti-fullwidth-label' >
						...
						$tip  = __( 'Choose who is allowed to book the groups of this category.', 'booking-activities' );
						$tip  .= '<br/>' . __( 'Use CTRL+Click to pick or unpick a role. Don\'t pick any role to allow everybody.', 'booking-activities' );
						bookacti_help_tip( $tip );
					?>
					</label>
