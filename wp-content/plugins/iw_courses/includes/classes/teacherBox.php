...
class teacherBox {
    ...
    public function save($post_id) {
        ...
        $image_gallery = array();
        if (isset($teacher_info['image_gallery']) && $teacher_info['image_gallery']) {
    ...
    public function render_meta_box_social_link($post) {
		...
		$data = array(
			...
			array('value' => 'instagram', 'text' => __('Instagram', 'inwavethemes')),
