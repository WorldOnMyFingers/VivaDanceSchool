...
$bt_options = (get_option('iw_courses_settings')) ? get_option('iw_courses_settings') : null;
$utility = new iwcUtility();

$pages = get_pages();
$pageList = array();
foreach ($pages as $page) {
    $pageList[$page->ID] = array();
    $pageList[$page->ID]['value'] = $page->ID;
    $pageList[$page->ID]['text'] = $page->post_title;
}
?>
<div class="tabs">
    <ul class="tab-links">
    ...
    <form action="<?php echo admin_url(); ?>admin-post.php" method="post">
        <div class="tab-content">
            <div id="display" class="tab active">
                ...
                <h3 class="header-text"><?php echo __("Booking setting"); ?></h3>
                <div class="control-group">
                    <div class="label"><?php echo __('Enable Woocommerce'); ?></div>
                    <div class="control">
                        <?php 
                        $data = array(
                        ...
                        echo $utility->selectFieldRender('enable_wc_booking', 'enable_wc_booking', (isset($bt_options['enable_wc_booking']) ? $bt_options['enable_wc_booking'] : '0'), $data, '', '', FALSE);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <h3 class="header-text"><?php echo __("Price settings"); ?></h3>
                <div class="control-group">
                    <div class="label"><?php echo __('Currency', 'inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        $data = $utility->getIWEventcurrencies();
                        echo $utility->selectFieldRender('currency', 'currency', (isset($bt_options['currency']) ? $bt_options['currency'] : 'USD'), $data, '', '', FALSE);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Currency Position', 'inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        $data_cpos = array(
                        ...
                        echo $utility->selectFieldRender('currency_pos', 'currency_pos', (isset($bt_options['currency_pos']) ? $bt_options['currency_pos'] : 'left'), $data_cpos, '', '', FALSE);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Decimal Separator', 'inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        $data = array(
                            array('text' => __('Period', 'inwavethemes'), 'value' => '.'),
                            array('text' => __('Comma', 'inwavethemes'), 'value' => ',')
                        );
                        echo $utility->selectFieldRender('decimal_separator', 'decimal_separator', (isset($bt_options['decimal_separator']) ? $bt_options['decimal_separator'] : '.'), $data, '', '', FALSE);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Thousands Separator', 'inwavethemes'); ?></div>
                    <div class="control">
                        <?php
                        $data = array(
                            array('text' => __('Period', 'inwavethemes'), 'value' => '.'),
                            array('text' => __('Comma', 'inwavethemes'), 'value' => ','),
                            array('text' => __('None', 'inwavethemes'), 'value' => 'none')
                        );
                        echo $utility->selectFieldRender('thousands_separator', 'thousands_separator', (isset($bt_options['thousandes']) ? $bt_options['thousands_separator'] : ','), $data, '', '', FALSE);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Number of Decimals', 'inwavethemes'); ?></div>
                    <div class="control">
                        <input name="number_of_decimals" value="<?php echo isset($bt_options['number_of_decimals']) ? $bt_options['number_of_decimals'] : 0; ?>" type="number" min="0"/>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <h3 class="header-text"><?php echo __("Permalink settings"); ?></h3>
                <div class="control-group">
                    <div class="label"><?php echo __('Courses slug'); ?></div>
                    <div class="control">
                        <input type="text" name="courses_slug" value="<?php echo ($bt_options['courses_slug']) ? $bt_options['courses_slug'] : 'iw-courses'; ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Teachers slug'); ?></div>
                    <div class="control">
                        <input type="text" name="teacher_slug" value="<?php echo ($bt_options['teacher_slug']) ? $bt_options['teacher_slug'] : 'iw-teacher'; ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    ...
                    <div class="control">
                        <input type="text" name="category_slug" value="<?php echo ($bt_options['category_slug']) ? $bt_options['category_slug'] : 'iw-class'; ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                ...
                <div class="control-group">
                    <div class="label"><?php echo __('Courses Page'); ?></div>
                    <div class="control">
                        <?php
                        echo $utility->selectFieldRender('courses_page', 'courses_page', $bt_options['courses_page'], $pageList, 'Select a page', '', false);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Teachers Page'); ?></div>
                    <div class="control">
                        <?php
                        echo $utility->selectFieldRender('teachers_page', 'teachers_page', $bt_options['teachers_page'], $pageList, 'Select a page', '', false);
                        ?>
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    <div class="label"><?php echo __('Courses listing limit'); ?></div>
                    <div class="control">
                ...
                <div class="control-group">
                    <div class="label"><?php echo __('Courses order'); ?></div>
                    <div class="control">
                        <?php
                        $order_data = array(
                ...
                <div class="control-group">
                    <div class="label"><?php echo __('Courses order direction'); ?></div>
                    <div class="control">
                        <?php
                ...
                <div class="control-group">
                    <div class="label"><?php echo __('Courses'); ?></div>
                    <div class="control">
                ...
                <div class="control-group">
                    ...
                    <div class="control">
                        <input name="image_width"  type="text" value="<?php echo ($bt_options['image_width'] ? $bt_options['image_width'] : '600'); ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    ...
                    <div class="control">
                        <input name="image_height"  type="text" value="<?php echo ($bt_options['image_height'] ? $bt_options['image_height'] : '400'); ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    ...
                    <div class="control">
                        <input name="thumb_width"  type="text" value="<?php echo ($bt_options['thumb_width'] ? $bt_options['thumb_width'] : '370'); ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
                    ...
                    <div class="control">
                        <input name="thumb_height"  type="text" value="<?php echo ($bt_options['thumb_height'] ? $bt_options['thumb_height'] : '250'); ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
            </div>
            ...
            <div id="advanced" class="tab">
                ...
                <div class="control-group">
                    ...
                    <div class="control">
                        <select name="enable_watemark_thumbnail">
                            <option <?php echo ($bt_options['enable_watemark_thumbnail'] == '0') ? 'selected = "selected"' : ''; ?> value="0"><?php echo __("No"); ?></option>
                            <option <?php echo ($bt_options['enable_watemark_thumbnail'] == '1') ? 'selected = "selected"' : ''; ?> value="1"><?php echo __("Yes"); ?></option>
                        </select>
                    </div>
                    <div style="clear: both"></div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="control">
                        <input name="wm_padding"  type="text" value="<?php echo ($bt_options['wm_padding'] ? $bt_options['wm_padding'] : '4'); ?>" />
                    </div>
                    <div style="clear: both"></div>
                </div>
                <div class="control-group">
        ...
        <input type="hidden" name="action" value="iw_courses_setting">
