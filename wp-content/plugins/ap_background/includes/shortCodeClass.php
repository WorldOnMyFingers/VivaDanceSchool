    ...
    private function generateParallaxBackgroundHTML($alias) {
        ...
        ?>
                ...
                <div class="parallax-background">
                    ...
                    <?php if ($item->settings->bg_type == 'img' && $item->settings->background_settings->image->background_image) : ?>
                        ...
                        ?>
                        <img src="<?php echo esc_url($background_url) ?>" alt="<?php echo __('Image background'); ?>"/>
                        <?php
                        ...
                        <div class="video-embed">
                            ...
                            <div class="video-wrap  <?php echo $video_url->media_source == 'direct' ? 'video-upload' : ''; ?>">
                                ...
                                elseif ($video_url->media_source == 'youtube'):
                                    ?>
                                    <iframe  id="iframe-<?php echo $parallax_id; ?>" width="100%" height="450" src="//www.youtube.com/embed/<?php echo $video_url->video_url; ?>?autoplay=1&controls=0&enablejsapi=1&fs=0&loop=1&rel=0&showinfo=0&version=3" frameborder="0" allowfullscreen></iframe>
                                    <?php
                                    if ($item->settings->background_settings->video->mute == 1):
        ...
        <?php endif; ?>
            ...
            slideSize: {'type':'<?php echo $item->settings->slider_size->width->type; ?>', 'size':'<?php echo $item->settings->slider_size->width->size; ?>'},
                    ...
                    parallaxOpenEffect: '<?php echo isset($item->settings->parallax_open_effect) ? $item->settings->parallax_open_effect : 'fancy'; ?>',
                    parallaxItem: '<?php echo isset($alias) ? $alias : ''; ?>',
                    speed: 2,
