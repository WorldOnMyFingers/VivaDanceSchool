...
//        Kiem tra xem media item co ton tai hay khong
        ...
        if ($media_item) {
            echo '<div class="thumb" ><img ' . $attr . ' src="' . (($media_item->media_source == 'image_upload') ? site_url() . '/wp-content/uploads/ap_background/thumb/' . $item->id . '/' . $media_item->thumbnail : $media_item->thumbnail ). '" alt="' . __('Image thumbnail') . '"/></div>';
