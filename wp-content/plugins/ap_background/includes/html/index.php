...
<div class="bt-parallax-wrap">
    ...
    <div class="control-buttons">
        <div class="create-button">
            <span class="button blue"><i class="fa fa-plus"></i> <?php echo __('CREATE NEW', 'inwavethemes'); ?></span>
        </div>
        <div class="delete-button">
            <span class="button red delete-items-list"><i class="fa fa-times"></i> <?php echo __('DELETE', 'inwavethemes'); ?></span>
        </div>
    ...
    <div class="list-item">
        <div class="header">
            <div scope="col" id="cb" class="column manage-column column-cb check-column" style="">
                <label class="screen-reader-text" for="cb-select-all-1"><?php __('Select All', 'inwavethemes'); ?></label>
                <input id="cb-select-all-1" type="checkbox">
            </div>
            <div scope="col" class="column manage-column column-id" style=""><?php echo __('ID', 'inwavethemes'); ?></div>
            <div scope="col" class="column manage-column column-title" style=""><?php echo __('Name', 'inwavethemes'); ?></div>
            <div scope="col" class="column manage-column column-short-code" style=""><?php echo __('Short Code', 'inwavethemes'); ?></div>
            ...
            <div scope="col" class="column manage-column column-last-modify" style="">
                <span><?php echo __('Last Modify', 'inwavethemes'); ?></span>
            </div>
            <div scope="col" class="column manage-column column-published" style="">
                <span><?php echo __('Published', 'inwavethemes'); ?></span>
            </div>	
            <div scope="col" class="column manage-column column-action" style="">
                <span><?php echo __('Action', 'inwavethemes'); ?></span>
            </div>
            <div class="clear"></div>
        </div>
        <?php
        ...
        if (!empty($items)):
            foreach ($items as $item):
                ...
                <div class="item">
                    ...
                    <div scope="row" class="row row-action" style="">
                        <a href="<?php echo admin_url('admin.php?page=bt-advance-parallax-background/create-new&content_type=' . $itemSettings->content_type . '&id=' . $item->id); ?>">
                            <span class="button green" title="<?php echo __('Edit', 'inwavethemes'); ?>"><i class="fa fa-pencil"></i></span>
                        </a>
                        <span class="button red delete" title="<?php echo __('Delete', 'inwavethemes'); ?>"><i class="fa fa-times"></i></span>
                        <span class="button blue copy" title="<?php echo __('Copy', 'inwavethemes'); ?>"><i class="fa fa-copy"></i></span>
                        <span class="button original preview" title="<?php echo __('Preview', 'inwavethemes'); ?>"><i class="fa fa-desktop"></i></span>
            ...
            ?>
            <?php echo __('No slider created', 'inwavethemes'); ?>
        <?php endif; ?>
    </div>
    <div class="control-buttons">
        <div class="create-button">
...
<div class="bt-parallax-select-slide-type hidden">
    <div class="bg-type-list-wrap">
        <div class="header-title"><?php echo __('BACKGROUND CONTENT TYPES', 'inwavethemes'); ?></div>
        <div class="bg-content-type-list">
            <div class="content-type-item selected video-background">
                ...
                <div class="item-title"><span><?php echo __('VIDEO BACKGROUND', 'inwavethemes'); ?></span></div>
            </div>
            <div class="content-type-item image-gallery end-row">
                ...
                <div class="item-title"><span><?php echo __('IMAGE GALLERY', 'inwavethemes'); ?></span></div>
            </div>
            <div class="content-type-item woo-commerce">
                ...
                <div class="item-title"><span><?php echo __('WOO COMMERCE', 'inwavethemes'); ?></span></div>
            </div>
            <div class="content-type-item wordpress-posts end-row">
                ...
                <div class="item-title"><span><?php echo __('WORDPRESS POSTS', 'inwavethemes'); ?></span></div>
            </div>
            <div class="clear"></div>
        </div>
        <div class="create-slideshow">
            <a href="<?php echo admin_url('admin.php?page=bt-advance-parallax-background/create-new&content_type=video-background'); ?>"><span class="button blue"><?php echo __('CREATE NEW SLIDESHOW', 'inwavethemes'); ?></span></a>
        </div>
    </div>
</div>
<div id="btp-item-preview" class="hidden">
    <div class="preview-close">
        <span class="button btn-none" title="<?php echo __('Close', 'inwavethemes'); ?>"><i class="fa fa-times"></i></span>
    </div>
