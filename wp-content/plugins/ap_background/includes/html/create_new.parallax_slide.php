...
<div class="group-content">
    ...
    <div class="content">
        ...
        <div class="control-group">
            ...
            <div class="control">
                <input type="text" name="slide_name" value="<?php echo $item->name ? htmlspecialchars(wp_unslash($item->name)) : ''; ?>"/>
            </div>
        ...
        <div class="control-group">
            ...
            <div class="control">
                <input type="text" placeholder="Example: 400" name="settings[min_width_allow]" value="<?php echo ($item->settings->min_width_allow) ? $item->settings->min_width_allow : ''; ?>"/>
            </div>
            <div style="clear: both"></div>
        </div>
        <div class="control-group">
            <div class="label"><?php echo __('Parallax open Effect.', 'inwavethemes'); ?></div>
            <div class="control">
                <?php
                $popen = array(
                    array('value' => 'fancy', 'text' => __('Fancy Effect', 'inwavethemes')),
                    array('value' => 'popup', 'text' => __('Simple Effect', 'inwavethemes'))
                );
                echo $bt_utility->selectFieldRender('parallax_open_effect', 'settings[parallax_open_effect]', $item->settings->parallax_open_effect, $popen, '', '', false);
                ?>
            </div>
            <div style="clear: both"></div>
        </div>
                    ...
                    <div class="background-act select-image">
                        <div class="image-preview">
                            ...
                            if ($item->settings->background_settings->image->background_image) {
                                ...
                                list($width, $height) = getimagesize($background_url);
                            ...
                            ?>
                            <div class="inner-image"><?php echo ($item->settings->background_settings->image->background_image) ? '<img ' . $style_img . ' src="' . $background_url . '"  alt="'.__('Loading...').'"/>' : ''; ?></div>
                        </div>
                    ...
                    <div class="background-act opacity">
                        <div class="image-preview">
                            <div class="inner-image">
                                ...
                                ?>
                                <div class="image"><?php echo ($item->settings->background_settings->image->background_image) ? '<img ' . $style_img . ' src="'.  $background_url . '"  alt="'.__('Loading...').'"/>' : ''; ?></div>
