...
<div class="group-content">
    ...
    <div class="content">
        ...
        <div class="custom-effect">
            ...
            <input type="hidden" id="ap_background_facebook_token" name="ap_background_facebook_token" value="<?php echo get_option('ap_background_facebook_token'); ?>"/>
        </div>
    </div>
</div>
...
<div class="bt-parallax-get-media-item hidden">
    <div class="bg-type-list-wrap">
        ...
        <div class="get-from-wrap facebook" style="display: none;">
            ...
            <div class="control-group">
                <div class="label"><?php echo __('Token Key', 'inwavethemes'); ?> <a href="https://developers.facebook.com/tools/explorer/" target="_blank"><?php _e('get here', 'inwavethemes');?></a></div>
                <div class="control">
                    <input placeholder="<?php echo __('Token key to get items from facebook', 'inwavethemes'); ?>" id="media_source_facebook_token" name="media_source_facebook_token" value="<?php echo get_option('ap_background_facebook_token'); ?>" type="text"/>
                </div>
                <div style="clear: both"></div>
            </div>
            <div class="control-group">
