    ...
    <div class="parallax-col">
        ...
        for ($j = 0; $j < $row_number; $j++):
            ...
            if ($media_item) {
                ...
                echo '<div class="thumb" style="width:' . $thumb_width . 'px; height:' . $thumb_height . 'px;"><img ' . $attr . ' src="' . (($media_item->media_source == 'image_upload') ?site_url() . '/wp-content/uploads/ap_background/thumb/' . $item->id . '/' . $media_item->thumbnail : $media_item->thumbnail) . '" alt="' . __('Image thumbnail') . '"/></div>';
