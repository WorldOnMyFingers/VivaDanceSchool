...
foreach ($items as $key => $media_item):
    ...
    if ($media_item->media_source == 'youtube'):
        $inputValue .='<iframe width="100%" height="450" src="//www.youtube.com/embed/' . $media_item->video_url . '?autohide=1&fs=1&rel=0&hd=1&wmode=opaque&enablejsapi=1&autoplay=1" frameborder="0" allowfullscreen></iframe>';
    endif;

    if ($media_item->media_source == 'vimeo'):
        $inputValue .='<iframe src="//player.vimeo.com/video/' . $media_item->video_url . '?hd=1&show_title=1&show_byline=1&show_portrait=0&fullscreen=1&autoplay=1" width="100%" height="450" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
    endif;
