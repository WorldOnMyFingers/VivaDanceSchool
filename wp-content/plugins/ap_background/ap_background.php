...
/*
  ...
  Plugin URI: http://apbackground.inwavethemes.com
...
include_once WP_PLUGIN_DIR . '/ap_background/includes/functions.admin.php';
include_once WP_PLUGIN_DIR . '/ap_background/includes/functions.front.php';
include_once WP_PLUGIN_DIR . '/ap_background/includes/shortCodeClass.php';
...
function btParallaxBackgroundAddAdminMenu() {
    add_menu_page(__('BT Advanced Parallax Background', 'inwavethemes'), __('AP Background', 'inwavethemes'), 'manage_options', 'bt-advance-parallax-background', 'pluginIndexRenderPage', plugins_url('assets/images/ap_icon.png',__FILE__));
    add_submenu_page(NULL, __('Add new', 'inwavethemes'),NULL, 'manage_options', 'bt-advance-parallax-background/create-new', 'pluginAddnewRenderPage');
}
