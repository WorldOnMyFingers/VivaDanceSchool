...
if (!class_exists('Inwave_Ethlete_Facts')) {
    ...
    class Inwave_Ethlete_Facts {
        ...
        function __construct() {
            ...
            // action init
            add_action('vc_before_init', array($this, 'ethlete_facts_init'));
        ...
        function ethlete_facts_init() {
            ...
            vc_map(
                    array(
                        "name" => __("Ethlete Facts",'inwavethemes'),
                        "base" => "inwave_ethlete_facts",
                        "content_element" => true,
                        'category' => 'InwaveThemes',
                        "description" => __("Add a set of list facts and give some custom style.", "inwavethemes"),
            ...
            vc_map(
                    array(
                        "name" => __("List Facts Item",'inwavethemes'),
                        ...
                        "params" => array(
                            array(
                                ...
                                "value" => "",
                                "admin_label" => true,
                                "description" => __("Click and select icon of your choice.", "inwavethemes"),
                            ),
                            array(
                                'type' => 'textfield',
                                "heading" => __("Count Number", "inwavethemes"),
                                "value" => rand(100, 1000),
