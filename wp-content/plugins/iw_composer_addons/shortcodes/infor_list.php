...
if (!class_exists('Inwave_Infor_List')) {
    ...
    class Inwave_Infor_List {
        ...
        function __construct() {
            ...
            // action init
            add_action('vc_before_init', array($this, 'infor_list_init'));
        ...
        function inwave_infor_list_item_shortcode($atts, $content = null) {
            ...
            switch ($this->style) {
                case 'style1':
                    ...
                    if ($icon) {
                        if ($link) {
                            $output .= '<div class="icon"><a target="'.$target.'" href="' . $link . '"><i class="fa fa-' . $icon . '"></i></a></div>';
                        } else {
                    ...
                    if ($title) {
                        if ($link) {
                            $output .= '<h4 class="infor-item-title"><a target="'.$target.'" href="' . $link . '">' . $title . '</a></h4>';
                        } else {
                ...
                case 'style2':
                    ...
                    if ($icon) {
                        if ($link) {
                            $output .= '<div class="icon-block"><a target="'.$target.'" href="' . $link . '"><i class="fa fa-' . $icon . '"></i></a></div>';
                        } else {
                    ...
                    if ($title) {
                        if ($link) {
                            $output .= '<h4 class="about-details-title"><a target="'.$target.'" href="' . $link . '">' . $title . '</a></h4>';
                        } else {
                ...
                case 'style3':
                    ...
                    if ($icon) {
                        if ($link) {
                            $output .= '<div class="icon-headding"><a target="'.$target.'" href="' . $link . '"><i class="fa fa-' . $icon . '"></i></a></div>';
                        } else {
                    ...
                    if ($title) {
                        if ($link) {
                            $output .= '<h5><a target="'.$target.'" href="' . $link . '">' . $title . '</a></h5>';
                        } else {
                            $output .= '<h5>' . $title . '</h5>';
                        }
                    }
