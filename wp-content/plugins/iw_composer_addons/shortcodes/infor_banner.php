...
if (!class_exists('Inwave_Infor_Banner')) {
    class Inwave_Infor_Banner
    {
        ...
        {
            add_action('vc_before_init', array($this, 'infor_banner_init'));
        ...
        function inwave_infor_banner_shortcode($atts, $content = null)
        {
            ...
            switch($layout) {
				...
				if($img_tag){
                    ...
                    $output .= '<div class="class-content '.$class.'">';
                    ...
                    break;
                case 'layout2':
                    $output .= '<div class="intro-content '.$class.'">';
					if($img_tag){
                    ...
                    break;
                case 'layout3':
                    $output .= '<div class="sevices-wapper '.$class.'">';
