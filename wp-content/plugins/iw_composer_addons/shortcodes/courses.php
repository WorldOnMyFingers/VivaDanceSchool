...
if (!class_exists('Inwave_Courses')) {
    ...
    class Inwave_Courses {
        ...
        function heading_init() {
            ...
            vc_map(array(
                'name' => 'Latest Courses',
                'description' => __('Show latest courses', 'inwavethemes'),
                'base' => 'inwave_courses',
                ...
                'params' => array(
                    array(
                        ...
                        "param_name" => "title",
                        "description" => __('Title of courses block.', "inwavethemes")
                    ),
                    array(
                        'type' => 'textfield',
                        "holder" => "div",
                        ...
                        "description" => __('Sub Title of courses block.', "inwavethemes")
                    ),
                    array(
                        'type' => 'textarea',
                        "holder" => "div",
                        ...
                        "description" => __('Description of courses block.', "inwavethemes")
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Number of Courses", "inwavethemes"),
                        "param_name" => "courses_count",
                        "value" => "2",
                        "description" => __('Number of courses to display on list.', "inwavethemes")
                    ),
                    array(
                        "type" => "textfield",
