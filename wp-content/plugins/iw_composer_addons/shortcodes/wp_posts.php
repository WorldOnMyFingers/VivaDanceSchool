            ...
            vc_map(array(
                ...
                'params' => array(
                    ...
                    array(
                        ...
                        "description" => __('Sub Title of wp_posts block.', "inwavethemes")
                    ),
                    array(
                        'type' => 'textarea',
                        "holder" => "div",
                        ...
                        "description" => __('Description of wp_posts block.', "inwavethemes")
                    ),
                    array(
                        'type' => 'textfield',
                        ...
                        foreach ($posts as $post) :
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="our-succes-top success">
                                    ...
                                    <p><?php echo $date . __(' by ', 'inwavethemes') . '<span>' . $author . '</span>' . __(' in ', 'inwavethemes') . '<span>' . $catName . '</span>'; ?></p>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                            ...
                            <div class="sport-content">
                                ...
                                <div class="read-more">
                                    <a href="<?php echo get_permalink(); ?>"><i
                                            class="fa fa-chevron-right"></i> <?php echo __('Read more', 'inwavethemes'); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php
