				...
				<div class="col-lg-9 col-md-10 p-0">
					<div class="top">
						<span class="call">
					        ...
					        <i class="fas fa-phone"></i><span class="col-org"><?php echo esc_html( get_theme_mod('nataraj_dance_studio_call','') ); ?></span>
					    	<?php } ?>
					    </span>	
					    <span class="call">
					    	<?php if( get_theme_mod( 'nataraj_dance_studio_mail','' ) != '') { ?>
					        <i class="fas fa-envelope"></i><span class="col-org"><?php echo esc_html( get_theme_mod('nataraj_dance_studio_mail','') ); ?></span>
					    	<?php } ?>
						</span>
						<span class="call">
			    	...
			    	<div class="col-lg-3 col-md-5 col-9">
			      	...
			      	<div class="col-lg-9 col-md-7 col-3">
						<div class="toggle-menu responsive-menu">
				            <button onclick="resMenu_open()" role="tab"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','nataraj-dance-studio'); ?></span></button>
				        </div>
						<div id="sidelong-menu" class="nav sidenav">
			                <nav id="primary-site-navigation" class="nav-menu" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'nataraj-dance-studio' ); ?>">
			                  <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="resMenu_close()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','nataraj-dance-studio'); ?></span></a>
			                  <?php 
			                    wp_nav_menu( array( 
