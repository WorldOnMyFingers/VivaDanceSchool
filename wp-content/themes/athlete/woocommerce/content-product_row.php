		...
		<div class="product-content">
			<div class="product-image col-md-4 col-sm-4 col-xs-12">
				...
				<?php if ( $product->is_on_sale() ) : ?>
					<?php echo apply_filters( 'woocommerce_sale_flash', '<span class="onsale-label">' . __( 'Sale!', 'inwavethemes' ) . '</span>', $post, $product ); ?>
				<?php endif; ?>
				...
				<div class="product-row-bottom">
					...
					<div class="actions-box">
						<ul>
							...
							<li>
								<a class="add_to_cart_button product_type_simple" data-product_id="<?php echo $product->get_id(); ?>" data-product_sku="<?php echo $product->get_sku() ?>" href="<?php echo esc_url( $product->add_to_cart_url() ) ?>" data-quantity="1"><i class="fa fa-shopping-cart"></i></a>
							</li>
