<?php
/**
 * @version   $Id: RokSprocket_Layout_Lists.php 22315 2014-07-22 14:00:19Z arifin $
...
class RokSprocket_Layout_Lists extends RokSprocket_AbstractLayout
{
	...
	protected function cleanItemParams()
	{
		foreach ($this->items as $item_id => &$item) {
			...
			$item->setParam('lists_item_icon',$this->setupText($item, 'lists_icon_default', 'false', 'lists_icon_default'));
